...
for i=1:nelem
    Ue=U(ldof2gdof(:,i));
    [Re_vol, dRe_vol] = intg_elem_claw_vol(Ue, transf_data(i), elem, elem_data(i));
    [Re_extface] = intg_elem_claw_extface(transf_data(i), elem, elem_data(i));
    Re(:,i)=Re_vol+Re_extface;
    dRe(:,:,i)=dRe_vol;
end
